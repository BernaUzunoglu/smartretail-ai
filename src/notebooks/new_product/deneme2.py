...
def main():
    try:
        ...
        indices_train, indices_test = train_test_split(indices, test_size=0.2, random_state=SEED, stratify=y,
                                                       shuffle=True)
        ...
        with open(os.path.join(Config.PROJECT_ROOT / 'src/models/product_purchase_potential/optimal_threshold.txt'),
                  'w') as f:
